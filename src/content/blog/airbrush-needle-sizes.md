...
seoTitle: "Airbrush Needle Sizes: Chart and What Each Does"
description: "A plain chart of 0.2, 0.3 and 0.5 mm needles, what each sprays well, which suits miniatures or T-shirts, and why 0.3 mm fits most painters."
pubDate: 2025-08-26
category: "beginners"
tags:
  - "airbrush needle sizes"
  - "needle size chart"
  - "0.3mm airbrush"
readingTime: 10
heroImage: "/images/airbrush-needle-sizes.webp"
draft: false
---
...
| Needle Size | Category | Finest Line | Max Spray Width | Best For | Paint Thinning | Clog Risk |
|---|---|---|---|---|---|---|
| **0.15mm** | Ultra-fine | Hair-thin | ~15mm | Competition miniatures, photo-realism, extreme detail | Heavy thinning required | Very high |
| **0.2mm** | Fine | ~0.5mm | ~25mm | Miniatures, fine detail, illustration, small models | Significant thinning | High |
| **0.3mm** | Medium | ~1mm | ~40mm | All-purpose, scale models, general hobby, learning | Moderate thinning | Moderate |
| **0.35mm** | Medium | ~1.5mm | ~50mm | All-purpose workhorse, most popular beginner size | Moderate thinning | Moderate |
| **0.4mm** | Medium-Large | ~2mm | ~60mm | Basecoating, priming, larger models, T-shirts | Light thinning | Low |
| **0.5mm** | Large | ~3mm | ~80mm | Priming, basecoating, large coverage, thick paints | Minimal thinning | Very low |
...
| Scale models (1/35, 1/48, 1/72) | 0.3mm all-rounder | Balances camo patterns with coverage |
| Large models (1/24 cars, ships) | 0.35–0.5mm | More coverage needed |
| Illustration / fine art | 0.2–0.3mm | Fine lines and gradients |
| T-shirts / fabric | 0.3–0.5mm | Textile paints are thicker |
| Automotive / helmets | 0.35–0.5mm | Large surfaces, thick paints |
| Cake decorating | 0.35–0.5mm | Food colors are thin, but broad coverage matters |
| Makeup / body art | 0.2–0.3mm | Precision on skin, thin media |
| Nails | 0.2mm | Tiny surfaces, extreme precision |
